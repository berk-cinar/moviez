    ...
    <div class=" w-full  flex flex-col md:flex-row shadow-md my-10">
      <div class=" md:w-2/3 bg-white px-10 py-10">
        ...
        <div class="flex justify-center w-1/5">
          <svg onClick={()=>dispatch(decreaseItemQuantity(item.id))
          ...
          <svg onClick={()=>dispatch(increaseItemQuantity(item.id))
      ...
      <div id="summary" class="md:w-1/3 px-8 py-10">
        ...
        <div class="flex justify-between mt-10 mb-5">
          ...
          <span class="font-semibold text-sm"> TOTAL PRİCE : ${totalPrice}</span>
        </div>
        <div>
